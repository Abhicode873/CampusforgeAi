      ...
      <GlassCard style={{ padding: 24, marginBottom: 24 }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            ...
            <button onClick={loadDemo} style={{ background: "rgba(59,130,246,0.12)", border: "1px solid rgba(59,130,246,0.3)", borderRadius: 20, color: "#3b82f6", padding: "6px 14px", cursor: "pointer", fontSize: 12, fontFamily: "'DM Sans', sans-serif" }}>🎯 Load Demo</button>
          </div>
        </div>
      </GlassCard>
    ...
    <div style={{ padding: "24px 28px", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ display: "grid", gridTemplateColumns: "350px 1fr", gap: 24 }}>
        ...
        <GlassCard style={{ padding: 24, height: "fit-content" }}>
          <div style={{ color: "#fff", fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 16, marginBottom: 20 }}>📊 How was your week, Arjun?</div>
        ...
        <div style={{ height: 300, overflowY: "auto", padding: "16px 20px" }}>
          ...
          {chat.map((m, i) => (
            <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start", marginBottom: 14 }}>
              ...
              <div style={{ maxWidth: "72%", background: m.role === "user" ? "rgba(59,130,246,0.2)" : "rgba(255,255,255,0.06)", border: `1px solid ${m.role === "user" ? "rgba(59,130,246,0.3)" : "rgba(255,255,255,0.08)"}`, borderRadius: 12, padding: "10px 14px", color: "rgba(255,255,255,0.85)", fontSize: 13, lineHeight: 1.6 }}>{m.text}</div>
            </div>
          ))}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 }}>
            {[["Your Score", 78, "Campus Avg", 68, "#3b82f6"], ["Your Streak", 5, "Top Streaker", 21, "#f43f5e"], ["Tasks Done", 8, "Class Avg", 5, "#10b981"]].map(([a, av, b, bv, c], i) => (
              <GlassCard key={i} style={{ padding: 20, textAlign: "center" }}>
                <div style={{ color, fontSize: 32, fontFamily: "'Syne', sans-serif", fontWeight: 800 }}>{av}</div>
...
const SettingsTab = () => (
  <div style={{ padding: "24px 28px", fontFamily: "'DM Sans', sans-serif" }}>
    <GlassCard style={{ padding: 24, maxWidth: 560 }}>
      ...
      {[["Student Name", "Arjun K."], ["College", "BVVSSS College"], ["Branch", "CSE"], ["Semester", "5th"], ["Email", "arjun.k@campus.edu"]].map(([label, val]) => (
...
export default function CampusForgeAI() {
  ...
  const [globalState, setGlobalState] = useState({ research: false, tasks: 0, score: 0, roadmap: false, streak: 5 });
        ...
        <div style={{ width: 240, background: "rgba(255,255,255,0.02)", borderRight: "1px solid rgba(255,255,255,0.06)", display: "flex", flexDirection: "column", position: "fixed", top: 0, bottom: 0, left: 0, zIndex: 100, backdropFilter: "blur(20px)" }}>
          ...
          <div style={{ padding: "16px 20px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
              <div style={{ width: 36, height: 36, borderRadius: "50%", background: "linear-gradient(135deg,#3b82f6,#7c3aed)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 13 }}>AK</div>
              <div>
                <div style={{ color: "#fff", fontWeight: 600, fontSize: 13 }}>Arjun K.</div>
                <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 11 }}>CSE · Sem 5</div>
              </div>
            </div>
            <div style={{ color: "rgba(255,255,255,0.3)", fontSize: 10, marginTop: 6 }}>BVVSSS College</div>
          </div>
        </div>
